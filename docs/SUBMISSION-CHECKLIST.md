...
| 02 | Reproduction guide | **Done.** `REPRODUCTION.md` — clean machine, exact commands, versions, runtimes, costs, and which sections need the full clone rather than the zip. Verified: full suite is **377 passed** in 141 s. |
