...
| # | Deliverable | Status |
|---|---|---|
| 01 | Complete solution code + **Improvement Changelog** | **Done.** `CHANGELOG.md` is titled *Improvement Changelog*, 28 iterations, each with what was tried, the evidence, and the decision — including five removed experiments. Failure mode and hot take are at the end, as the brief asks. |
...
| Archive | Size |
|---|---|
| all 914 tracked files, `zip -9` | **54 MB** — over the cap |
...
| 02 | Clear what existed before vs. what you added | ✅ README *Provenance*: everything written during the competition except `docs/Problem Statement.pdf`. |
...
- **Measured Improvement (15)** — the brief asks for *"ten or more cases"*, *"one
  ...
  side tuned to agree). Make sure at least one of these is spoken aloud in the
  video — a project that names the case it still gets wrong reads differently
